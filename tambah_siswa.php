          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              <form method="POST" action="">
                <div class="card-body">
                  <tr>
                <td>Nama Dudi<span class="text-success">*</span></td>
                <td>
                  <select name="id_dudi" class="form-control" required>
                    <option value=""> -- Pilih -- </option>
                    <?php
                    $qr = mysqli_query($koneksi, "SELECT * FROM dudi");
            ...
            <button type="submit" value="Cari" name="cari" class="btn btn-success btn-icon-split btn-sm">
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nis" placeholder="NIS">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nama_siswa" placeholder="Nama Siswa">
                  </div>
                  <div class="form-group">
...
<?php
  if(isset($_POST['simpan'])){
    ...
    $id_dudi = $_POST['nama'];
     ...
     $sql = mysqli_query($koneksi, " INSERT INTO siswa VALUES('', '$nis', '$nama_siswa', '$jk', '$alamat', '$username', '$password', '$nama' )");
